...
const (
	VoteService_Vote_FullMethodName         = "/redyx.vote.v1.VoteService/Vote"
	VoteService_GetVoteState_FullMethodName = "/redyx.vote.v1.VoteService/GetVoteState"
)
...
type VoteServiceClient interface {
	...
	GetVoteState(ctx context.Context, in *GetVoteStateRequest, opts ...grpc.CallOption) (*GetVoteStateResponse, error)
}
...
func (c *voteServiceClient) GetVoteState(ctx context.Context, in *GetVoteStateRequest, opts ...grpc.CallOption) (*GetVoteStateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetVoteStateResponse)
	err := c.cc.Invoke(ctx, VoteService_GetVoteState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VoteServiceServer interface {
	...
	// GetVoteState returns the current user's vote on a specific item.
	GetVoteState(context.Context, *GetVoteStateRequest) (*GetVoteStateResponse, error)
...
func (UnimplementedVoteServiceServer) GetVoteState(context.Context, *GetVoteStateRequest) (*GetVoteStateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetVoteState not implemented")
}
...
func _VoteService_GetVoteState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVoteStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VoteServiceServer).GetVoteState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VoteService_GetVoteState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoteServiceServer).GetVoteState(ctx, req.(*GetVoteStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VoteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "redyx.vote.v1.VoteService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetVoteState",
			Handler:    _VoteService_GetVoteState_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "redyx/vote/v1/vote.proto",
}
