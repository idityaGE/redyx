...
// account deletion (soft-delete), and stub endpoints for posts/comments.
package user
...
// GetUserPosts returns an empty paginated list (stub until Phase 3 — post service).
func (s *Server) GetUserPosts(ctx context.Context, req *userv1.GetUserPostsRequest) (*userv1.GetUserPostsResponse, error) {
	s.logger.Debug("GetUserPosts stub — post service not available until Phase 3",
...
// GetUserComments returns an empty paginated list (stub until Phase 4 — comment service).
func (s *Server) GetUserComments(ctx context.Context, req *userv1.GetUserCommentsRequest) (*userv1.GetUserCommentsResponse, error) {
	s.logger.Debug("GetUserComments stub — comment service not available until Phase 4",
		zap.String("username", req.GetUsername()),
	)
